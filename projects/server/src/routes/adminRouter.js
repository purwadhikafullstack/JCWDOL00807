...
Router.get("/getDataSales", tokenVerify, adminController.getDataSales);
...
Router.post(
  "/create-admin-branch",
  tokenVerify,
  validationAdminBranch,
  validationRun,
  adminController.createAdminBranch
);
Router.patch(
  "/update-admin-branch",
  tokenVerify,
  validationAdminBranch,
  validationRun,
  adminController.updateAdminBranch
);
Router.delete(
  "/delete-admin-branch",
  tokenVerify,
  adminController.deleteAdminBranch
);
